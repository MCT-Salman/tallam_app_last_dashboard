            ...
            <CardHeader className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <div className="text-sm text-muted-foreground">
                        عرض {filteredAndSortedSpecializations.length} من أصل {allSpecializations.length} عنصر
                                    ...
                                    {paginatedSpecializations.length > 0 ? paginatedSpecializations.map(item => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell className="table-cell text-right space-x-2">
                                                <Button size="icon" variant="ghost" onClick={() => handleToggleActive(item.id, item.isActive)}>
                                                    {item.isActive ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                                                </Button>
                                                <Button
                                                    size="icon"
